    ...
    <div ref={containerRef}>
              ...
              {branches.map((b, idx) => (
                <div key={b.id} className="glass" style={{ ...T.brCard, borderColor: hovered === b.id ? `${b.color}99` : 'rgba(255,255,255,.09)', padding: '20px 24px' }}
                  ...
                  <div style={{ position: 'relative', zIndex: 3, display: 'flex', alignItems: 'center', gap: 20 }}>
                    <div style={{ fontSize: '2.5rem' }}>{b.emoji}</div>
                    <div style={{ flex: 1 }}>
      ...
      <footer style={{ ...T.footer, padding: '60px 20px' }}>
        <div style={{ maxWidth: 1440, margin: '0 auto', textAlign: 'center' }}>
          <div style={{ marginBottom: 20, display: 'flex', justifyContent: 'center', gap: 30, flexWrap: 'wrap' }}>
            {['🇰🇷 Janubiy Koreya', '🇩🇪 Germaniya', '🏢 Samarqand', '🌴 Termiz'].map(t => <span key={t} style={{ color: '#00C9B1', fontWeight: 700, fontFamily: 'Rajdhani', fontSize: 16 }}>{t}</span>)}
          </div>
...
const T = {
  ...
  secHead: { textAlign: 'center', marginBottom: 80 },
  tag: { display: 'inline-block', fontFamily: 'Orbitron,monospace', fontSize: 12, letterSpacing: '5px', color: '#00C9B1', textTransform: 'uppercase', marginBottom: 20, padding: '8px 20px', borderLeft: '5px solid #00C9B1', fontWeight: 700, background: 'rgba(0,201,177,.08)' },
  h2: { fontFamily: 'Orbitron,monospace', fontSize: 'clamp(28px,4vw,56px)', fontWeight: 900, marginBottom: 16, color: '#fff', lineHeight: 1.1, transformOrigin: 'center top' },
  ...
  statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(min(100%,300px),1fr))', gap: 30 },
  statCard: { padding: '44px 32px', textAlign: 'center', cursor: 'default', position: 'relative', background: 'rgba(5,22,55,.9)', border: '1.5px solid rgba(255,255,255,.1)', borderRadius: 24 },
  statIcon: { width: 74, height: 74, borderRadius: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px' },
  statNum: { fontFamily: 'Orbitron,monospace', fontSize: 'clamp(2.6rem,4vw,3.6rem)', fontWeight: 900, lineHeight: 1, marginBottom: 14 },
  statLbl: { fontSize: '18px', fontWeight: 700, color: '#fff', marginBottom: 10, fontFamily: 'Rajdhani' },
  statDesc: { fontSize: '14px', color: '#6da9c8', marginBottom: 16 },
  trend: { display: 'inline-block', marginTop: 14, padding: '7px 18px', border: '1px solid', borderRadius: 24, fontSize: 14, fontWeight: 700, fontFamily: 'Rajdhani' },
  parGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(min(100%,350px),1fr))', gap: 28 },
  parCard: { padding: '40px 36px 40px 96px', position: 'relative', cursor: 'default', background: 'rgba(5,18,48,.92)', border: '1.5px solid rgba(255,255,255,.1)', borderRadius: 24 },
  mapLayout: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 500px), 1fr))', gap: 64, alignItems: 'center' },
  ...
  brCard: { cursor: 'default', position: 'relative', background: 'rgba(4,18,48,.96)', border: '1.5px solid', borderRadius: 22, transition: 'all .3s' },
  eBtn: { borderRadius: 10, cursor: 'pointer', fontFamily: 'Orbitron', fontSize: 12, fontWeight: 700, border: '1.5px solid rgba(0,201,177,.4)', color: '#00C9B1', background: 'transparent', display: 'flex', alignItems: 'center', gap: 8, transition: 'all .25s' },
  ctaSec: { padding: '140px 64px', textAlign: 'center', position: 'relative', zIndex: 10, background: 'linear-gradient(135deg,rgba(0,201,177,.1),rgba(0,229,255,.05))', borderTop: '1px solid rgba(0,201,177,.2)', overflow: 'hidden' },
  ctaCard: { maxWidth: 1080, margin: '0 auto', padding: '100px 64px', cursor: 'default', background: 'rgba(4,20,52,.98)', border: '1.5px solid rgba(0,201,177,.25)', borderRadius: 36 },
